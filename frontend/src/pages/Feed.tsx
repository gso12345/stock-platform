...
const MARKET_BADGE: Record<string, string> = {
  KR:  "bg-accent-blue/15 text-accent-blue border-accent-blue/20",
  US:  "bg-accent-green/15 text-accent-green border-accent-green/20",
  ETF: "bg-accent-purple/15 text-accent-purple border-accent-purple/20",
};

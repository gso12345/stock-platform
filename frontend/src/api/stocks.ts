...
export const communityApi = {
  ...
  updatePost: (market: string, symbol: string, postId: number, title: string, body: string, tags?: any[], poll?: any) =>
    api.put(`/community/${market}/${symbol}/posts/${postId}`, { title, body, tags, poll }).then((r) => r.data),
